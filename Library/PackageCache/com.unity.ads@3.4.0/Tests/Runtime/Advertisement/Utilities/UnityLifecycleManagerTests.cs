...
namespace UnityEngine.Advertisements.Tests
{
    public class UnityLifecycleManagerTests
    {
        ...
        public void CheckGameObject()
        {
            ...
            Assert.That(gameObject.hideFlags, Is.EqualTo(HideFlags.HideInInspector | HideFlags.HideInHierarchy | HideFlags.DontSave));
            ...
            Assert.That(applicationQuitMonoBehavior.hideFlags, Is.EqualTo(HideFlags.HideInInspector | HideFlags.HideInHierarchy | HideFlags.DontSave));
            ...
            Assert.That(coroutineExecutorMonoBehavior.hideFlags, Is.EqualTo(HideFlags.HideInInspector | HideFlags.HideInHierarchy | HideFlags.DontSave));
        }
